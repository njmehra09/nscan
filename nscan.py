...
def get_banner():
    # 100% Exact Same Layout but with proper color parsing enabled!
    print(f"{C} _  _  ____   ___    __   __  __")
    print(f"{C}| \\| |/ ___| / __|  /  \\  | \| |")
    print(f"{C}| .  |\\___ \| |__  / /\\ \\ |    |")
    print(f"{C}|_|\_||____/ \___|/_/  \\_\\|_|\_|")
    print(f"\n{Y}Made By {G}NS Hacker{W} Simple, Fast, Accurate {C}🔗 https://t.me/nscan_script{W}")
    print(f"{C}======================================================={W}")
